...
function AccommodationCard({
  ...
  return (
    <div className="glass-card rounded-2xl overflow-hidden group hover:shadow-2xl transition-all duration-500 md:hover:scale-[1.02] hover:-translate-y-1 accommodation-card-mobile w-full max-w-full">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between mb-4 gap-3">
          <div className="flex-1 min-w-0">
            <div className="flex items-center space-x-2 sm:space-x-3 mb-2">
              ...
              <h3 className="font-bold text-base sm:text-lg text-foreground group-hover:text-emerald-500 transition-colors duration-300 truncate">
                {accommodation.name}
              </h3>
            </div>

            {accommodation.type && (
              <div className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-emerald-500/20 text-emerald-600 border border-emerald-500/30">
          ...
          {accommodation.address && (
            <div className="p-3 rounded-xl backdrop-blur-sm bg-background/30 border border-white/10">
              <div className="flex items-center space-x-2">
                ...
                <p className="text-sm text-foreground truncate flex-1">{accommodation.address}</p>
              </div>
            </div>
          )}
