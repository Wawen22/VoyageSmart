        ...
        <div className="py-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-3">
              <h3 className="font-medium text-center">Free:</h3>
              <div className="space-y-2">
                <div className="flex items-start">
                  <CheckIcon className="h-4 w-4 text-primary mr-2 mt-0.5 flex-shrink-0" />
                  <p className="text-sm">Create up to 5 trips</p>
                </div>
                <div className="flex items-start">
                  <CheckIcon className="h-4 w-4 text-primary mr-2 mt-0.5 flex-shrink-0" />
                ...
                <div className="flex items-start">
                  <CheckIcon className="h-4 w-4 text-primary mr-2 mt-0.5 flex-shrink-0" />
                  <p className="text-sm">Accommodations management</p>
                </div>
                <div className="flex items-start">
                  <CheckIcon className="h-4 w-4 text-primary mr-2 mt-0.5 flex-shrink-0" />
                  <p className="text-sm">Transportation tracking</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-start">
                  <CheckIcon className="h-4 w-4 text-primary mr-2 mt-0.5 flex-shrink-0" />
                  <p className="text-sm">Unlimited trips</p>
                </div>
                <div className="flex items-start">
                  <CheckIcon className="h-4 w-4 text-primary mr-2 mt-0.5 flex-shrink-0" />
                ...
                <div className="flex items-start">
                  <CheckIcon className="h-4 w-4 text-primary mr-2 mt-0.5 flex-shrink-0" />
                  <p className="text-sm">Advanced expense analytics</p>
                </div>
                <div className="flex items-start">
                  <CheckIcon className="h-4 w-4 text-primary mr-2 mt-0.5 flex-shrink-0" />
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-start">
                  <CheckIcon className="h-4 w-4 text-primary mr-2 mt-0.5 flex-shrink-0" />
                  <p className="text-sm">24/7 AI travel assistant</p>
                </div>
                <div className="flex items-start">
                  <CheckIcon className="h-4 w-4 text-primary mr-2 mt-0.5 flex-shrink-0" />
                  <p className="text-sm">Smart itinerary optimization</p>
                </div>
                <div className="flex items-start">
                  <CheckIcon className="h-4 w-4 text-primary mr-2 mt-0.5 flex-shrink-0" />
                  <p className="text-sm">Budget forecasting</p>
                </div>
                <div className="flex items-start">
                  <CheckIcon className="h-4 w-4 text-primary mr-2 mt-0.5 flex-shrink-0" />
                  <p className="text-sm">Personalized travel insights</p>
                </div>
              </div>
            </div>
          </div>
