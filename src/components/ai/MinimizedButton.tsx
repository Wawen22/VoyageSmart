...
export default function MinimizedButton({
  ...
  return (
    <button
      ...
      className="fixed sm:bottom-4 bottom-[80px] sm:right-4 right-2 bg-gradient-to-br from-purple-600 to-indigo-600 text-white p-3 sm:p-4 rounded-2xl shadow-2xl z-[48] flex items-center gap-2 sm:gap-3 hover:from-purple-500 hover:to-indigo-500 transition-all duration-300 ai-float backdrop-blur-xl border border-purple-500/20 ai-button-hover ai-chat-trigger"
